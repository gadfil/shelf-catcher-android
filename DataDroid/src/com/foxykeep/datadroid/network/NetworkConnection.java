...
public final class NetworkConnection {
    ...
    /**
     * Create a {@link com.foxykeep.datadroid.network.NetworkConnection}.
     * <p>
     * The Method to use is {@link com.foxykeep.datadroid.network.NetworkConnection.Method#GET} by default.
     *
     * @param context The context used by the {@link com.foxykeep.datadroid.network.NetworkConnection}. Used to create the
     *            User-Agent.
    ...
    /**
     * Set the method to use. Default is {@link com.foxykeep.datadroid.network.NetworkConnection.Method#GET}.
     * <p>
     * If set to another value than {@link com.foxykeep.datadroid.network.NetworkConnection.Method#POST}, the POSTDATA text will be reset as it can
     ...
     * {@link com.foxykeep.datadroid.network.NetworkConnection.Method} to {@link com.foxykeep.datadroid.network.NetworkConnection.Method#POST} to be able to use it.
     * <p>
    ...
    /**
     * Execute the webservice call and return the {@link com.foxykeep.datadroid.network.NetworkConnection.ConnectionResult}.
     *
